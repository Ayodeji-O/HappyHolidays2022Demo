// Katie-Ayo_HappyHolidays2022Main.js - Happy Holidays 2022 demo entry point
...
function initDomResources(completionFunction) {
	...
	if (Utility.validateVar(mainCanvas) &&
		...
		if (Utility.validateVar(mainCanvasContext)) {
			...
			var gaugeOverlayTexture = WebGlUtility.createTextureFromCanvas(mainCanvasContext,
				gaugeOverlayCanvas, false);
...
renderTextIntoIntroductoryScreenCanvas = function(targetContext) {	
	...
	[	
		[ 250, 60, Constants.stringIntroGeneral1],
		[ 60, 120, Constants.stringIntroMoveInstruction],
		[ 285, 570, Constants.stringIntroHazardDesc],		
		[ 490, 150, Constants.stringIntroGoalDesc],
...
function executeMainScene () {		
	...
	var snowDuneBunnyGameplayScene = new MainSnowDuneBunnyGameplayScene();
	sceneExecution(snowDuneBunnyGameplayScene);
}
